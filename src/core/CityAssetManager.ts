...
export class CityAssetManager {
    ...
    private static readonly factionFlagMap: { [key: string]: string } = {
        'huaxia': '/SUCAI/S10QZ/15-1.png',
        'zhonghua': '/SUCAI/S10QZ/9-1.png',
        'tianchao': '/SUCAI/S10QZ/7-1.png',
        'chaoxian': '/SUCAI/S10QZ/8-1.png',
        'caowei': '/SUCAI/S10QZ/43-1.png',
        //'tianchao': '/SUCAI/S10QZ/43-1.png',
        //'jin': '/SUCAI/S10QZ/7-1.png',


        'manzhou': '/SUCAI/S10QZ/10-1.png',
        'xiyang': '/SUCAI/S10QZ/11-1.png',
        'xiyu': '/SUCAI/S10QZ/12-1.png',
        'panjun': '/SUCAI/S10QZ/13-1.png',
        'yuenan': '/SUCAI/S10QZ/14-1.png',
        'song': '/SUCAI/S10QZ/16-1.png',

        //'chaoxian': '/SUCAI/S10QZ/17-1.png',
        'qiangzang': '/SUCAI/S10QZ/19-1.png',
        'gan': '/SUCAI/S10QZ/20-1.png',
        'zhou': '/SUCAI/S10QZ/21-1.png',
        'jue': '/SUCAI/S10QZ/23-1.png',
        'dianmian': '/SUCAI/S10QZ/24-1.png',
        //'sui': '/SUCAI/S10QZ/25-1.png',
        //'zhu': '/SUCAI/S10QZ/26-1.png',
        'zang': '/SUCAI/S10QZ/27-1.png',
        'shu': '/SUCAI/S10QZ/29-1.png',
        'qi': '/SUCAI/S10QZ/30-1.png',

        'liang_x': '/SUCAI/S10QZ/32-1.png', // Added liang_x
        'shang': '/SUCAI/S10QZ/33-1.png',
        //'tang': '/SUCAI/S10QZ/34-1.png',
        'e': '/SUCAI/S10QZ/38-1.png',
        'liang': '/SUCAI/S10QZ/39-1.png',

        //'chu': '/SUCAI/S10QZ/41-1.png',
        'riben': '/SUCAI/S10QZ/42-1.png',

        'huihui': '/SUCAI/S10QZ/44-1.png',
        'han_x': '/SUCAI/S10QZ/45-1.png', // Added han_x
        //'yuan': '/SUCAI/S10QZ/46-1.png',

        'tian': '/SUCAI/S10QZ/48-1.png',
        'nan': '/SUCAI/S10QZ/49-1.png',
        'qu': '/SUCAI/S10QZ/50-1.png',
        'shi': '/SUCAI/S10QZ/51-1.png',
        'min': '/SUCAI/S10QZ/52-1.png',
        'yue': '/SUCAI/S10QZ/54-1.png',
        'gao': '/SUCAI/S10QZ/55-1.png',

        'xia': '/SUCAI/S10QZ/57-1.png',
    ...
    private static readonly factionFlagTextMap: { [key: string]: string } = {
        'zhonghua': '/SUCAI/S10QZ/240-1.png',
        'yuan': '/SUCAI/S10QZ/yuan-2.png',
        'tianchao': '/SUCAI/S10QZ/241-1.png',
        'chaoxian': '/SUCAI/S10QZ/239-1.png',
        'huihui': '/SUCAI/S10QZ/171-1.png',
        'caowei': '/SUCAI/S10QZ/89-1.png',
        'qiangzang': '/SUCAI/S10QZ/81-1.png',
        'yuenan': '/SUCAI/S10QZ/243-1.png',

        'tian': '/SUCAI/S10QZ/tian-2.png',
        //'zhu': '/SUCAI/S10QZ/129-1.png',
        'liang_x': '/SUCAI/S10QZ/226-1.png',
        //'han_x': '/SUCAI/S10QZ/81-1.png',
        'huaxia': '/SUCAI/S10QZ/352-1.png',
        'manzhou': '/SUCAI/S10QZ/100-1.png',
        //'zhonghua': '/SUCAI/S10QZ/258-1.png',
        //'tianchao': '/SUCAI/S10QZ/106-1.png',
        //'qiangzang': '/SUCAI/S10QZ/236-1.png',
        //'yuenan': '/SUCAI/S10QZ/235-1.png',
        //'jin': '/SUCAI/S10QZ/244-1.png',
        //'tang': '/SUCAI/S10QZ/183-1.png',
        'song': '/SUCAI/S10QZ/159-1.png',
        'riben': '/SUCAI/S10QZ/234-1.png',
        'xia': '/SUCAI/S10QZ/78-1.png',
        'shang': '/SUCAI/S10QZ/259-1.png',
        'zhou': '/SUCAI/S10QZ/131-1.png',
        'shu': '/SUCAI/S10QZ/233-1.png',
        //'qi': '/SUCAI/S10QZ/240-1.png',
        //'chu': '/SUCAI/S10QZ/241-1.png',
        'liang': '/SUCAI/S10QZ/242-1.png',
        //'sui': '/SUCAI/S10QZ/261-1.png',
        'dianmian': '/SUCAI/S10QZ/411-1.png',
        'xiyu': '/SUCAI/S10QZ/317-1.png',
        'xiyang': '/SUCAI/S10QZ/148-1.png',
        'zang': '/SUCAI/S10QZ/160-1.png',
        'jue': '/SUCAI/S10QZ/60-1.png',
        'nan': '/SUCAI/S10QZ/238-1.png',
        'e': '/SUCAI/S10QZ/74-1.png',
        'qu': '/SUCAI/S10QZ/448-1.png',
        'shi': '/SUCAI/S10QZ/253-1.png',
        'min': '/SUCAI/S10QZ/270-1.png',
        'gan': '/SUCAI/S10QZ/85-1.png',
        //'yue': '/SUCAI/S10QZ/243-1.png',
        'gao': '/SUCAI/S10QZ/109-1.png',
    };
